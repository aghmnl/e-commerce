...
export default function Settings() {
    ...
    function ChangeEmail(values){
        axios.put("http://localhost:3001/user/change_email", values, { withCredentials:true })
            .then(() => alert("OK"))
            .catch((err) => console.log(err))
    }
    function ChangePassword(values){
        axios.put("http://localhost:3001/user/change_password", values,{withCredentials:true})
            .then(async() => {
    ...
    return (
        <div>
            <Card style={{margin: "3rem auto", textAlign: "left" }}>
                <Card.Body>
                    <ListGroup>
                        <ListGroup.Item>
                        ...
                        <ListGroup.Item>
                            <Form onSubmit={changeEmail.handleSubmit} style={{width:"30rem"}}>
                                <Form.Group as={Col}>
                        ...
                        <ListGroup.Item>
                            <Form onSubmit={changePass.handleSubmit} style={{width:"30rem"}} >
                                <Form.Group as={Col}>
                                ...
                                <Form.Group as={Col}>
                                    ...
                                    />
                                    <Form.Control.Feedback type="invalid" tooltip>
                                        {changePass.errors.new_password && changePass.touched.new_password && changePass.errors.new_password}
                                    </Form.Control.Feedback>
                                </Form.Group>
                                <Form.Group as={Col}>
